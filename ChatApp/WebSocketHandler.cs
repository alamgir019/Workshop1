...
namespace ChatApp
{
    public abstract class WebSocketHandler
    {
        ...
        internal async Task SendPrivateMessage(WebSocket senderSocket, string receiver, string message)
        {
            await SendMessageAsync(senderSocket, message);
            var socketId = ConnectionManager.GetSocketIdByUserName(receiver);
